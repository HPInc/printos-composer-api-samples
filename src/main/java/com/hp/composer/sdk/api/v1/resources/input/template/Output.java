...
public class Output {
	...
	private Boolean richTemplate;
	private Boolean embeddedImpositionExist;
	...
	public Boolean getRichTemplate() {
		return richTemplate;
	}

	public void setRichTemplate(Boolean richTemplate) {
		this.richTemplate = richTemplate;
	}

	public Boolean getEmbeddedImpositionExist() {
		return embeddedImpositionExist;
	}

	public void setEmbeddedImpositionExist(Boolean embeddedImpositionExist) {
		this.embeddedImpositionExist = embeddedImpositionExist;
	}
	...
	public String toString(){
		...
		stringBuilder.append("richTemplate:").append(richTemplate).append(", ");
		stringBuilder.append("embeddedImpositionExist:").append(embeddedImpositionExist).append(", ");
		stringBuilder.append("numberOfPages:").append(numberOfPages).append(", ");
