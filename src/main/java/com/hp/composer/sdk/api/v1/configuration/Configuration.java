...
public class Configuration {
	...
	public static String apiBaseUrl = "https://www.printos.com/api/composer-service/v1";
	...
	public static String hmacAlgorithm = "SHA256";
	public static String javaxCryptoName = "HmacSHA256";
